...
```{r}
# Address mismatch between absolute viral load and undetectable/suppressed
blood_draw_form$blood_vl_q2[blood_draw_form$blood_vl_q2 == 1 & 
                            !is.na(blood_draw_form$blood_vl_q4) & 
                            blood_draw_form$blood_vl_q4 > 200] <- 0
```
...
trust_m[Item %in% c(2,3,4,6,8,9,10), Response_n := ifelse(Response %in% 1:5, Response - 1, as.integer(NA))]
