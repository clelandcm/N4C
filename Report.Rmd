...
## Viral Load < 200 copies/mL at Baseline (n=222)
```{r, results='asis'}
mytab4 <- gtsummary::tbl_cross(wide_VL[pid %in% Enrolled & 
                               ...
                               percent = "cell",
                               label = list(FU1_Undetectable ~ "Undetectable at 9M", 
                                            FU2_Undetectable ~ "Undetectable at 18M"))
print(mytab4)
```

## Viral Load $>=$ 200 copies/mL at Baseline (n=52)
```{r, results='asis'}
