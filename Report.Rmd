...
mytab4 <- gtsummary::tbl_cross(wide_VL[pid %in% Enrolled & 
                                       ...
                                       !is.na(FU1_Undetectable),], 
                               row = BL_Undetectable, 
                               col = FU1_Undetectable,
                               percent = "cell",
                               label = list(BL_Undetectable ~ "Undetectable at BL", 
                                            FU1_Undetectable ~ "Undetectable at 9 Month Follow-Up"))
print(mytab4)
```
...
wide_VL[, BL_Undetectable := dplyr::case_when(BL_Undetectable == "Yes" ~ "Undetectable at BL (n=222)",
                                              BL_Undetectable == "No" ~ "Detectable at BL (n=52)")]

wide_VL[, FU1_Undetectable := dplyr::case_when(FU1_Undetectable == "Yes" ~ "Undetectable at 9M",
                                               FU1_Undetectable == "No" ~ "Detectable at 9M")]

wide_VL[, FU2_Undetectable := dplyr::case_when(FU2_Undetectable == "Yes" ~ "Undetectable at 18M",
                                               FU2_Undetectable == "No" ~ "Detectable at 18M")]
```
...
-   n=`r nrow(change_VL_status)` participants have had a change in suppression over time
