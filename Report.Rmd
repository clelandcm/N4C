...
FUrate <- merge(DT[redcap_event_name == "baseline_interview_arm_2",.(pid, Days_Since_BL, Time_Cat)],
                DT[redcap_event_name == "follow_up_1_interv_arm_2",.(pid, follow_up_1_interview_editing_complete, fu1_date)],
                all=TRUE)
...
```{r}
table1(~ FU1_Completion | Time_Cat, data = FUrate, overall = FALSE)
```
...
* n=`r length(na.omit(n4c$fu1_end))` first follow-up interviews completed 
