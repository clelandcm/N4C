...
enroll_new <- data.frame(day = seq(as.Date("2021-12-07"), as.Date("2023-07-30"), 1))
...
## By Viral Load
```{r, fig.width = 6, fig.asp = 0.8, out.width = "90%"}
enroll_new_VL <- expand.grid(blood_vl_q2 = c("No","Yes"), bl_date = seq(as.Date("2021-12-07"), as.Date("2023-07-30"), 1))
