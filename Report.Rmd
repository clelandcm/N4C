...
FUrate <- merge(DT[redcap_event_name == "baseline_interview_arm_2" & !is.na(bl_date),.(pid, Days_Since_BL, Time_Cat)],
                DT[redcap_event_name == "follow_up_1_interv_arm_2" & !is.na(follow_up_1_interview_editing_complete),.(pid, follow_up_1_interview_editing_complete, fu1_date)],
                all=TRUE)

FUrate[, FU1_Completion := ifelse(is.na(follow_up_1_interview_editing_complete) | 
                                    follow_up_1_interview_editing_complete != 2, "No", "Yes")]
...
## Nine Months
### Interview Completion by Days Since Baseline
```{r}
table1(~ FU1_Completion | Time_Cat, data = FUrate)
```
