...
-   **n=`r length(setdiff(Enrolled, sn_bl$pid))` enrolled participants without responses to social network items at baseline**
-   **n=`r nrow(wform)` withdrawn participants excluded**
